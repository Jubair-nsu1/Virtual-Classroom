...
if (!(isset($_SESSION['username']))) {
    ...
    include_once 'dbConnection.php';
    echo '<span class="pull-right top title1" ><span style="color:white"></span><a href="student_home.php" style="color:lightyellow"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Main Menu</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></span>';
}
?>
...
if (@$_GET['q'] == 3)
    echo 'class="active"';
?>><a href="account.php?q=3"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Results</a></li>>
    <li <?php
if (@$_GET['q'] == 4)
    echo 'class="active"';
?>><a href="account.php?q=4"><span class="glyphicon glyphicon-tasks" aria-hidden="true"></span>&nbsp;Assignments</a></li>>
   <li <?php
if (@$_GET['q'] == 5)
    echo 'class="active"';
?>><a href="account.php?q=1"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;MCQ Exam<span class="sr-only">(current)</span></a></li>>
    <li <?php
if (@$_GET['q'] == 6)
    echo 'class="active"';
?>><a href="account.php?q=6"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp;Written Exams</a></li></ul>
...
if (@$_GET['q'] == 4) {
  ...
  include_once("dbConnection.php");
  $sql = "Select topic,date,time From Assignment ";
  ...
  while( $record = mysqli_fetch_assoc($resultset) ) {
    ...
    $s = "Select turnin From assign_submission WHERE assign_name='$topic' ";
    $r = mysqli_query($con, $s) or die("database error:". mysqli_error($con));
    if( $rec = mysqli_fetch_assoc($r) ) {
      $submission = $rec['turnin'];
    }
  ?>



    <a href="assignment_student.php?topic=<?php echo $topic ?> " class="panel">
      <center><h4 style="color:orange"><?php echo $topic ?></h4></center></br>
      <p>Date: <?php echo $date?></p>
      <p>Time: <?php echo $time?></p><br>
      <p style="color:yellow"> <?php echo $submission?></p>
    </a>
