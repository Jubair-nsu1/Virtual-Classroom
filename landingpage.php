...
<!--hero header-->
<section class="py-7 py-md-0 bg-hero" id="#">
</br></br>
    <div class="container">
        ...
        <!--          <img class="card-img-top" src="img_avatar1.png" style="width:100%">      -->
                  <div class="card-body">
                      ...
                      <a href="faculty_register.php" class="btn btn-primary stretched-link">Join As Faculty</a>
                  </div>
                </div>
              </div>
</br>
        ...
        <!--          <img class="card-img-top" src="img_avatar1.png"  style="width:100%">        -->
                  <div class="card-body">
                      ...
                      <a href="student_register.php" class="btn btn-primary stretched-link">Join As Student</a>
                  </div>
                </div>
              </div>
