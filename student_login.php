...
<section class="py-7 py-md-0 bg-hero" id="student_login">
  	<div class="container">
  		<div class="row">
  		<div class="col-md-3"></div>
  		<div class="col-md-6">
  		<h3 class="h3_txt"><center>  		Student Login  </center></h3>
    ...
    <div class="form-row">
  	...
  	<center><input type="submit" name="student_login" class="btn btn-primary" value="Login"  <br></center>
  </form>
  		</div>
  		<div class="col-md-3"></div>
